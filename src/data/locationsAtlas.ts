import rawLocationsAtlas from '../../public/images/locations.json';
...
const raw = rawLocationsAtlas as unknown as RawAtlas;

export const locationsAtlasMeta: AtlasMeta | null = raw.__meta
  ? {
      w: raw.__meta.w,
      h: raw.__meta.h,
...
export const locationsAtlasFrames: Record<string, AtlasFrame> = (() => {
