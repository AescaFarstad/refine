...
const quests: Record<string, RawQuestDefinition> = {
  ...
  dyatlovsk_defeat_the_hive: {
    ...
    encounters: [
      { kind: 'AddMonsterMutation', monsterId: 'hive', count: 4 },
    ],
    rewards: [
      { kind: 'raid_loot_chance', delta: 10 },
  ...
  dyatlovsk_portal_flower: {
    ...
    encounters: [
      { kind: 'AddMonsterMutation', monsterId: 'burdock', count: 25 },
      { kind: 'AddMonsterMutation', monsterId: 'flower', count: 15 },
      { kind: 'AddMonsterMutation', monsterId: 'mortiflower', count: 10 },
      { kind: 'AddMonsterMutation', monsterId: 'dendroid', count: 5 },
    ],
    rewards: [
  ...
  dyatlovsk_raise_the_dome: {
    ...
    encounterTimeMin: 80,
    encounters: [
      { kind: 'AddMonsterMutation', monsterId: 'lightning', count: 2 },
    ],
    rewards: [
  ...
  dyatlovsk_raise_the_dome_even_higher: {
    ...
    raidRestriction: ['dyatlovsk'],
    encounterTimeMin: 180,
    requiresQuestIds: ['dyatlovsk_raise_the_dome'],
    encounters: [
      { kind: 'AddMonsterMutation', monsterId: 'lightning', count: 5 },
    ],
    rewards: [
      { kind: 'raid_mutation', mutation: { kind: 'ZoneCollapseTimeMutation', amount: 2400 } },
      { kind: 'raid_mutation', mutation: { kind: 'AddMonsterMutation', monsterId: 'lightning', count: 4 } },
    ],
  },
};
