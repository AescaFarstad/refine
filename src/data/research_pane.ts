...
export const researchPaneVoidCells: Point2[] = [
  ...
  { x: 11, y: -8 }, { x: 13, y: -8 }, { x: 14, y: -8 }, { x: 16, y: -8 }, { x: -10, y: -7 }, { x: -8, y: -7 },
  { x: -6, y: -7 }, { x: -4, y: -7 }, { x: -1, y: -7 }, { x: 13, y: -7 }, { x: 15, y: -7 }, { x: -10, y: -6 },
  { x: -8, y: -6 }, { x: -6, y: -6 }, { x: -4, y: -6 }, { x: 5, y: -6 }, { x: 14, y: -6 }, { x: -10, y: -5 },
  { x: -8, y: -5 }, { x: 8, y: -5 }, { x: -10, y: -4 }, { x: -6, y: -4 }, { x: -2, y: -4 }, { x: 3, y: -4 },
  { x: 10, y: -4 }, { x: -7, y: -3 }, { x: -3, y: -3 }, { x: 9, y: -3 }, { x: 10, y: -3 }, { x: -7, y: -2 },
  { x: 4, y: -2 }, { x: -10, y: -1 }, { x: 2, y: -1 }, { x: -11, y: 0 }, { x: -9, y: 0 }, { x: -4, y: 0 },
  { x: -12, y: 1 }, { x: -10, y: 1 }, { x: -7, y: 1 }, { x: -6, y: 1 }, { x: 3, y: 1 }, { x: -12, y: 2 },
  { x: -10, y: 2 }, { x: -2, y: 2 }, { x: 2, y: 2 }, { x: 5, y: 2 }, { x: -12, y: 3 }, { x: -11, y: 3 },
  { x: -9, y: 3 }, { x: -8, y: 3 }, { x: -7, y: 3 }, { x: -6, y: 3 }, { x: -5, y: 3 }, { x: 6, y: 3 },
  { x: 8, y: 3 }, { x: -10, y: 4 }, { x: 5, y: 4 }, { x: 10, y: 4 }, { x: -10, y: 5 }, { x: -9, y: 5 },
  { x: 4, y: 5 }, { x: 6, y: 5 }, { x: 8, y: 5 }, { x: -5, y: 6 }, { x: -1, y: 6 }, { x: 10, y: 6 },
  { x: -11, y: 7 }, { x: 2, y: 7 }, { x: 4, y: 7 }, { x: 6, y: 7 }, { x: 8, y: 7 }, { x: -12, y: 8 },
  { x: -10, y: 8 }, { x: -8, y: 8 }, { x: -7, y: 8 }, { x: -5, y: 8 }, { x: -4, y: 8 }, { x: 9, y: 8 },
  { x: -12, y: 9 }, { x: -11, y: 9 }, { x: -2, y: 9 }, { x: 0, y: 9 }, { x: 2, y: 9 }, { x: 4, y: 9 },
  { x: 6, y: 9 }, { x: -9, y: 10 }, { x: -8, y: 10 }, { x: -7, y: 10 }, { x: -6, y: 10 }, { x: -5, y: 10 },
  { x: -4, y: 10 }, { x: 7, y: 10 }, { x: -2, y: 11 }, { x: 0, y: 11 }, { x: 2, y: 11 }, { x: 4, y: 11 },
  { x: -10, y: 12 }, { x: -9, y: 12 }, { x: -8, y: 12 }, { x: -7, y: 12 }, { x: -6, y: 12 }, { x: -5, y: 12 },
  { x: -4, y: 12 }, { x: 5, y: 12 }, { x: -2, y: 13 }, { x: 0, y: 13 }, { x: 2, y: 13 }, { x: -10, y: 14 },
  { x: -9, y: 14 }, { x: -8, y: 14 }, { x: -7, y: 14 }, { x: -6, y: 14 }, { x: -5, y: 14 }, { x: -4, y: 14 },
  { x: 3, y: 14 }, { x: -2, y: 15 }, { x: 0, y: 15 }, { x: -4, y: 16 }, { x: 1, y: 16 }, { x: -3, y: 17 },
  { x: -1, y: 17 },
];
