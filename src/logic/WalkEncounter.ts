...
export function handleWalkEncounter(r: ActiveRaid): WalkEncounterLogEntry {
  ...
  r.hp = r.hp + healed;
  return { kind: 'WalkEncounter', hpBefore, hpAfter: r.hp, timeSpentSec: sec, elapsedTotalSec: 0, currentHp: 0, currentMaxHp: 0, bagsUsed: 0, bagsCapacity: 0, injected: false, speedKmH: kmh, maxSpeedKmH: maxKmh, maxHp: r.maxHp, hasPainkiller, hpHealed: healed };
}
